...
INSERT IGNORE INTO shopping_dashboard.product (product_id, brand, product_name, weight) VALUES(4, 'Nestle', 'Snickers', 0.4);
INSERT IGNORE INTO shopping_dashboard.product (product_id, brand, product_name, weight) VALUES(5, 'Kryniczanka', 'Woda mineralna gazowana', 1.5);
INSERT IGNORE INTO shopping_dashboard.product (product_id, brand, product_name, weight) VALUES(6, 'Nestle', 'Płatki śniadaniowe', 5.5);
...
INSERT IGNORE INTO shopping_dashboard.shopping_list (id, created_at, list_name, user_id, shop_id)
VALUES(2, now(), 'testowa biedronkowe', (select id from users where email = 'justyna@gmail.com'), 2);
